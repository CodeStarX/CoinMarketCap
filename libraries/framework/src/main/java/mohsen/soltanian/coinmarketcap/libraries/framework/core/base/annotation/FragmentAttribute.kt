package mohsen.soltanian.coinmarketcap.libraries.framework.core.base.annotation

@kotlin.annotation.Target(AnnotationTarget.ANNOTATION_CLASS, AnnotationTarget.CLASS)
annotation class FragmentAttribute(val layoutId: Int = -1,val handleBackPress: Boolean = false,
