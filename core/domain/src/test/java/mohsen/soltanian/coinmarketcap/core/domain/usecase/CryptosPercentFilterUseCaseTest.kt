...
internal class CryptosPercentFilterUseCaseTest: DomainUnitTest() {

    @MockK lateinit var uesCase: CryptosPercentFilterUseCase

    @MockK(relaxed = true) lateinit var params: CryptosPercentFilterUseCase.Params
