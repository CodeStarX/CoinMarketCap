...
internal class CryptosSortUseCaseTest: DomainUnitTest() {

    @MockK lateinit var uesCase: CryptosSortUseCase

    @MockK(relaxed = true) lateinit var params: CryptosSortUseCase.Params
