...
class CryptoSortPagingSource(
    private val serviceImp: ServiceImp,
    private val sortParams: CryptosSortUseCase.Params
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CryptoCurrency> {
        ...
        return try {
            val response = serviceImp.getCryptosBySort(start = page.toString(), sortType = sortParams.sorType)
